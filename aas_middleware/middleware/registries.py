...
class AsyncConnectionRegistry:
    ...
    def __init__(self):
        self.connectors: typing.Dict[str, AsyncConnector] = {}
        self.connection_types: typing.Dict[str, typing.Type[typing.Any]] = {}
        self.connections: typing.Dict[ConnectionInfo, typing.List[str]] = {}

    def get_connector_id(self, connector: AsyncConnector) -> str:
        """
        Function to get a connector id from the connection manager.

        Args:
            connector (AsyncConnector): The connector of the connection.
    ...
    def get_connector(self, connector_id: str) -> AsyncConnector:
        """
        Function to get a connector from the connection manager.
    ...
    def add_connector(
        ...
        Args:
            connector_id (str): The name of the connector.
            connector (AsyncConnector): The connector to be added.
            connection_type (typing.Type[Connector]): The type of the connector.
        """
        self.connectors[connector_id] = connector
        self.connection_types[connector_id] = connection_type
    ...
    def get_connections(
    ...
    ) -> typing.List[typing.Tuple[AsyncConnector, typing.Type[typing.Any]]]:
        """
        Function to get a connection from the connection manager.
        ...
        Returns:
            AsyncConnector: The connector of the connection.
        """
        connector_ids = self.connections[connection_info]
        connections = []
        for connector_id in connector_ids:
